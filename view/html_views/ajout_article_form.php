...
<div class="max-w-2xl bg-white py-10 px-5 m-auto w-full mt-10">
    ...
    <div class="space-y-5">
        ...
        <div class="col-span-2 lg:col-span-1">
            <input name="title" type="text" class="border-solid border-gray-400 border-2 p-3 md:text-xl w-full" placeholder="Titre" />
        </div>

        <div class="col-span-2 lg:col-span-1">
            <textarea name="description" type="text" class="border-solid border-gray-400 border-2 p-3 md:text-xl w-full" placeholder="Contenu"></textarea>
        </div>
